...
def train_only(data_dir, weights_save_path, epochs, batch_size, pre_trained_weights, min_disp, max_disp):
    ...
    :return:
    '''
    net = PSMNet(1024, 1024, 1, min_disp, max_disp)
    net.build_model()
...
def weights2pb(weights, pb_dir, height, width, min_disp, max_disp):
    ...
    :return:
    '''
    net = PSMNet(height, width, 1, min_disp, max_disp)   # 参数1,2,4,5可以自行指定，如(4096, 4096, 1, -192.0, 128.0)，但必须是64的倍数
...
if __name__ == '__main__':
    ...
    # weights_save_path = '/home/hesheng/Networks/PSMNet/weights/PSMNetMIX{epoch:003d}.h5'
    # epochs = 30
    # batch_size = 2
    # pre_trained_weights = '/home/hesheng/Networks/PSMNet/weights/PSMNetWHU.h5'
    # min_disp, max_disp = -96.0, 48.0
    # train_only(data_dir, weights_save_path, epochs, batch_size, pre_trained_weights, min_disp, max_disp)

    weights = '/home/hesheng/Networks/PSMNet/weights/PSMNetMIX026.h5'
    pb_dir = '/home/hesheng/Networks/PSMNet/model/PSMNetMIX2048'
    height, width = 2048, 2048
    min_disp, max_disp = -144.0, 80.0
